...
const FROM = {
  ...
  document: process.env.MELHOR_ENVIO_FROM_DOCUMENT || "05206799000190",
  company_document: process.env.MELHOR_ENVIO_FROM_DOCUMENT || "05206799000190",
  state_register: null as null,
  address: process.env.MELHOR_ENVIO_FROM_ADDRESS || "Rua Goiás",
  number: process.env.MELHOR_ENVIO_FROM_NUMBER || "304",
  complement: null as null,
  district: process.env.MELHOR_ENVIO_FROM_DISTRICT || "Vila Santa Maria",
