      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">
            Acesse sua conta para realizar compras
          </p>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-dark-700 border border-dark-500 rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-primary transition pr-10"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary text-black font-semibold py-3 rounded-xl hover:bg-primary-light transition disabled:opacity-50"
          >
